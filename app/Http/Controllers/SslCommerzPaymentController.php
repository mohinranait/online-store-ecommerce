...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if(Auth::check()){
            ...
            $post_data['cus_user_id']       = $request->user_id;
            $post_data['cus_name']          = $request->name;
            $post_data['cus_division']      = $request->division;
            ...
            $post_data['cus_country']       = $request->cuntry;
            ...
            return redirect('login')->with('warning',' Login First , Then Checkout');
        }
    ...
    public function success(Request $request)
    {
        ...
        $order_detials = DB::table('orders')
            ...
            foreach( Card::totalItems() as $item ){
                $item->order_id = $order_detials->id;
                $item->save();
            }
