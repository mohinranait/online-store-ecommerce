                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-8 m-auto">
                                ...
                                <form method="POST" action="{{route('cuntry.store')}}" enctype="multipart/form-data">
                                    @csrf 
                                
                                    <div class="form-group ">
                                        <label>cuntry Name : <span class="tx-danger">*</span></label>
                                        <input type="text" name="cuntry" class="form-control " placeholder="cuntry name"  required>
                                    </div><!-- form-group -->
                                    <div class="form-group ">
                                        <div class="row">
                                            <div class="col-lg-12">
                                    ...
                                    <div class="form-group ">
                                        <button type="submit" class="btn btn-info">Save Cuntry</button>
                                    </div>
                                </form>
