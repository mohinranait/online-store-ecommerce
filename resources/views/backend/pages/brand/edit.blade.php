    ...
    <div class="br-mainpanel">
        <div class="br-pagetitle" style='background:linear-gradient(to right, #1CAF9A 0%, #17A2B8 100%)'>
            ...
            <div>
                ...
                <p class="mg-b-0 text-dark">Update Brand.</p>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-header tx-medium">
                        <div class='d-flex align-items-center justify-content-between'>
                            <h4 class='text-dark'>Update Brand</h4>
                            ...
                            <div class="col-lg-8 m-auto">
                                ...
                                <form method="POST" action="{{route('brand.update', $brand->id)}}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input type="text" name="brand" class="form-control " value="{{$brand->name}}" placeholder="Brand name"  required>
                                    </div><!-- form-group -->

                                    <div class="form-group ">
                                        <label>Sort Description (Optionnal)</label>
                                        <textarea rows="2" name='description' class="form-control" placeholder="Write now" style="height: 101px;">{{$brand->name}}</textarea>
                                    </div><!-- form-group -->
                                    ...
                                    <select class='form-control' name="status" id="">
                                        ...
                                        <option value="2" @if( $brand->status == 2 ) selected @endif>In-Active</option>
