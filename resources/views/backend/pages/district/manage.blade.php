...
@section('title') <title>District list</title> @endsection
    ...
    <div class="br-mainpanel">
        <div class="br-pagetitle" style='background:linear-gradient(to right, #1CAF9A 0%, #17A2B8 100%)'>
            ...
            <div>
                ...
                <p class="mg-b-0 text-dark">All  District Board.</p>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-header tx-medium">
                        <div class='d-flex align-items-center justify-content-between'>
                            <h4 class='text-dark'>District List</h4>
                            <a href="{{route('district.create')}}" class='btn btn-info '>Create District</a>
                        </div>
                    ...
                    <table class="table table-bordered mg-b-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <div>
                                    <a href="{{route('district.edit', $items->id)}}" class='btn btn-primary btn-sm text-white'><i class='fa fa-edit'></i> EDIT</a>
                                    ...
                                    <div id="delModal{{$items->id}}" class="modal fade show" style="padding-right: 17px;">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            ...
                                            <div class="modal-body pd-25">
                                                <h4 class="lh-3 mg-b-20"><a href="" class="tx-inverse hover-primary">Delete <b class='text-primary'>{{$items->name}}</b> District ?</a></h4>
                                                <p class="mg-b-5">  </p>
                                            </div>
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{route('district.delete', $items->id)}}" method='POST'>
                                                    @csrf 
                        ...
                        @else
                            <div class="alert alert-info text-center">No District Found</div>
                        @endif
                    </table>
