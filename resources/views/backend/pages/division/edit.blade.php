...
@section('title') <title>Division Edit  </title> @endsection
                            ...
                            <div class="col-lg-8 m-auto">
                                ...
                                <form method="POST" action="{{route('division.update', $division->id)}}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input type="text" name="division" value="{{$division->name}}" class="form-control " placeholder="Division name"  required>
                                    </div><!-- form-group -->
                                    <div class="form-group ">
