        ...
        <nav class="nav">
          ...
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              ...
              @if(Auth::user()->image)
              <img src="{{asset('image/'. Auth::user()->image)}}" class="wd-32 rounded-circle" alt="" style='width:30px;height:30px'>
              @else
            ...
            <div class="dropdown-menu dropdown-menu-header wd-250">
              <div class="tx-center">
                <a href="">
                @if(Auth::user()->image)
                  <img src="{{asset('image/'. Auth::user()->image)}}" class="wd-80 rounded-circle" alt="" style='width:60px;height:60px'>
                @else
              ...
              <ul class="list-unstyled user-profile-nav">
                <li><a href="{{route('user.edit' , Auth::user()->id)}}"><i class="icon ion-ios-person"></i> Edit Profile</a></li>
