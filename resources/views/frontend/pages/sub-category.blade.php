                		...
                		<div class="col-lg-9">
                			<div class="toolbox">
                				<div class="toolbox-left">
                					<div class="toolbox-info">
										@php $totalProduct =  App\Models\Product::where('cat_id', $categorys->id)->count() @endphp
                						Showing <span>9 of {{$totalProduct}}</span> Products
                            ...
                            <div class="products mb-3">
                                <div class="row justify-content-center">
                                   ...
                                   @if( App\Models\Product::where('cat_id', $categorys->id)->count() > 0)
                                   ...
                                   <div class="alert alert-info text-center">
                                       No Product Found This <strong>{{$categorys->name}}</strong> Category
                                   </div>
                                   @endif
