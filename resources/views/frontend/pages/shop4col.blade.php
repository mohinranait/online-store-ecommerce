                			...
                			<div class="toolbox">
                				...
                				<div class="toolbox-right">
                					...
                					<div class="toolbox-layout">
                						...
                						<a href="{{route('shop-fore')}}" class="btn-layout active">
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4 col-xl-3" >
                                        <div class="product product-7 text-center" style='border:1px solid #ddd'>
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="{{route('productdetails', $product->slug)}}">{{substr(strip_tags($product->name), 0, 30)}}</a></h3><!-- End .product-title -->
