...
<head>
   ...
   @yield('title')
    ...
    <meta name="keywords" content="E-commerce Website">
    <meta name="description" content="E-commerce website">
    <meta name="author" content="Mohin Rana">
    <!-- Favicon -->
    <!-- Favicon -->
    ...
    <link rel="stylesheet" href="{{asset('frontend')}}/css/productgallary.css">
...
<body>
    <div class="page-wrapper">
       ...
       @yield('content')
        ...
        <footer class="footer">
            <div class="cta bg-image bg-dark pt-4 pb-5 mb-0" style="background-image: url({{asset('frontend')}}/images/demos/demo-4/bg-5.jpg);">
                <div class="container">
	        ...
	        <div class="footer-bottom">
	        	<div class="container">
	        		<p class="footer-copyright">Copyright © 2019 Mohin Rana. All Rights Reserved.</p><!-- End .footer-copyright -->
                ...
                <div class="row no-gutters bg-white newsletter-popup-content">
                    <div class="col-xl-3-5col col-lg-7 banner-content-wrap">
                        <div class="banner-content text-center">
                            <img src="{{asset('frontend')}}/images/popup/newsletter/logo.png" class="logo" alt="logo" width="60" height="15">
                    ...
                    <div class="col-xl-2-5col col-lg-5 ">
                        <img src="{{asset('frontend')}}/images/popup/newsletter/img-1.jpg" class="newsletter-img" alt="newsletter">
                    </div>
                </div>
            </div>
        </div>
